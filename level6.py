...
class Level6(arcade.View):
    ...
    def on_show_view(self):
        ...
        self.fireball1 = FireBall(290, 1420, 673)
        self.fireball2 = FireBall(460, 1420, 635)
        self.fireball3 = FireBall(734, 1420, 633)
        self.fireball4 = FireBall(990, 1420, 640)
        self.fireball5 = FireBall(1168, 1420, 610)
        self.fireball6 = FireBall(1400, 1420, 665)
        self.fireball_list = [self.fireball1, self.fireball2, self.fireball3, self.fireball4, self.fireball5, self.fireball6]

        self.cannon = Cannon(170, 945, self.player_sprite, True)
        self.cannon2 = Cannon(1550, 980, self.player_sprite, False) # another one at (1550, 445)
